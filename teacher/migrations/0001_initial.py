# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2018-09-27 06:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_tester', models.FileField(blank=True, default='', null=True, upload_to=teacher.models.upload_to1, verbose_name='实验室上传文件')),
                ('time_to_upload', models.DateField(verbose_name='上传时间')),
                ('sampleinfoformid', models.CharField(max_length=200, verbose_name='客户上传表格编号')),
                ('arrive_time', models.DateField(verbose_name='样品接收时间')),
                ('sample_status', models.IntegerField(choices=[(0, '未核对'), (1, '已核对')], default=0, verbose_name='样品状态')),
                ('sample_jindu', models.IntegerField(choices=[(0, '项目进行中'), (1, '项目已完结')], default=0, verbose_name='样品进度')),
                ...
                ('saler', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='销售联系人', to=settings.AUTH_USER_MODEL, verbose_name='销售代表')),
                ...
                ('transform_contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='物流联系人', to=settings.AUTH_USER_MODEL, verbose_name='物流联系人')),
            ],
            options={
                'verbose_name': '样品信息',
        ...
        migrations.AddField(
            ...
            name='sampleinfoform',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='teacher.SampleInfoForm'),
        ),
    ]
